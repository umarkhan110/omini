    ...
    const fetchData = async () => {
      try {
        ...
        console.error("API Key Invalid")
          ...
          const searchDDL = 'SELECT%20COUNT(ai_4)%20AS%20count_ai,%20ai_4%20FROM%20.seednode_syslog%20GROUP%20BY%20ai_4%20ORDER%20BY%20count_ai%20DESC';
      ...
      <Col xs={24} xl={24}>
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h4  style={{fontSize:'21px', fontWeight:'600', marginBottom:'10px'}}>Boudica analytics AI_4</h4>
            <div>
            </div>
          </div>
          ...
          <div className="w-100">
              <div id="revenue4-chart" dir="ltr" style={{ height: '293px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #f0f0f0', borderRadius: '2px' }}>
                {errorMessage ? (
